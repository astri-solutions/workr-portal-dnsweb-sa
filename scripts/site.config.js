...
export const siteConfig = {
  ...
  nav: [
    { id: "docs-cvm", label: "Documentos CVM", labels: {"pt-BR":"Documentos CVM"}, href: "/documentos-cvm.html", pageType: "lista-agrupada", listaAgrupadaStyle: "accordion", listaAgrupadaCategories: [{"id":"Comunicados e Fatos","label":"Comunicados ao Mercado","labels":{"pt-BR":"Comunicados ao Mercado"}},{"id":"Fatos Relevantes","label":"Fatos Relevantes"},{"id":"Atas","label":"Atas"},{"id":"Formulário Cadastral","label":"Formulário Cadastral"},{"id":"mk-8myeyd5","label":"Aviso aos Acionistas","labels":{"pt-BR":"Aviso aos Acionistas"}},{"id":"mk-atq9c73","label":"Assembleias","labels":{"pt-BR":"Assembleias"}},{"id":"mk-fcn3f0z","label":"Formulário Cadastral","labels":{"pt-BR":"Formulário Cadastral"}},{"id":"mk-fhl7w9a","label":"Formulário de Referência","labels":{"pt-BR":"Formulário de Referência"}},{"id":"mk-3q3ucso","label":"Conselho de Administração","labels":{"pt-BR":"Conselho de Administração"}},{"id":"mk-eoyh23d","label":"Resolução CVM 44/2021","labels":{"pt-BR":"Resolução CVM 44/2021"}},{"id":"mk-wu1v8sy","label":"Valores Mobiliários Detidos e Negociados - Resolução CVM n°44","labels":{"pt-BR":"Valores Mobiliários Detidos e Negociados - Resolução CVM n°44"}},{"id":"mk-bz3zzsg","label":"Reunião da Administração","labels":{"pt-BR":"Reunião da Administração"}}], children: [] },
    { id: "atas-assembleias", label: "Atas e Assembleias", labels: {"pt-BR":"Atas e Assembleias"}, href: "/atas-assembleias.html", pageType: "lista-agrupada", listaAgrupadaStyle: "accordion", listaAgrupadaCategories: [{"id":"Atas","label":"Atas"},{"id":"Assembleias","label":"Assembleias"},{"id":"mk-0c4xfv0","label":"Políticas"}], children: [] },
    { id: "fale-ri", label: "Fale com RI", href: "/fale-com-ri.html", children: [] },
    { id: "mailing", label: "Mailing", labels: {"pt-BR":"Mailing"}, href: "/mailing.html", pageType: "formulario", children: [] },
  ...
  footer: {
    ...
    content: {"en":{"hours":"Segunda a sexta, das 08h às 18h, exceto feriados.","phone":"(11) 1234-5678","address":"Av. Brigadeiro Faria Lima, 2.277, 17º andar — São Paulo/SP, CEP 01452-000","copyright":"©Copyright Workr Lite - DNSWEB SA 2026 EN","disclaimer":"As informações contidas neste site são de caráter meramente informativo e não constituem oferta de valores mobiliários."},"es":{"hours":"Segunda a sexta, das 08h às 18h, exceto feriados.","phone":"(11) 1234-5678","address":"Av. Brigadeiro Faria Lima, 2.277, 17º andar — São Paulo/SP, CEP 01452-000","copyright":"©Copyright Workr Lite - DNSWEB SA 2026 ES","disclaimer":"As informações contidas neste site são de caráter meramente informativo e não constituem oferta de valores mobiliários."},"pt-BR":{"hours":"Segunda a sexta, das 08h às 18h, exceto feriados.","phone":"(11) 1234-5678","address":"Av. Brigadeiro Faria Lima, 2.277, 17º andar — São Paulo/SP, CEP 01452-000","copyright":"©Copyright Workr Lite - DNSWEB SA 2026 PT","disclaimer":"As informações contidas neste site são de caráter meramente informativo e não constituem oferta de valores mobiliários."}},
    social: { linkedin: "#", instagram: "#", facebook: "#" },
    legalLinks: [
      { label: "Termos e Condições EN", href: "/termos-e-condicoes.html" },
  ...
  banner: [
    {
      "id": "b1",
      "imagem": "/assets/banner/b1-a1252ee366b5.webp",
      "content": {
        "en": {
          "cta": "Learn more",
